...
class UserAction {
        ...
        if ($_SERVER['REQUEST_METHOD'] == 'POST') {
            ...
            if ($user) {
                ...
                if ($user['user_role'] == 'customer') {
                    header("Location: shop.php"); // Redirect to customer dashboard
                    exit();
    ...
    public function sendOtpEmail($email, $otp) {
        ...
        try {
            ...
            $mail->SMTPAuth = true;
            $mail->Username = 'inezanicol@gmail.com'; // Your email address
            $mail->Password = 'ktqe kdif yieo bqls'; // Your email password
